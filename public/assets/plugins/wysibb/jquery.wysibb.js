...
//			direction:			"ltr",
			...
			smileList: [
			   {img: '<img src="assets/img/smileys/abruti.gif" class="sm">', bbcode:" :abruti: ", title: 'Abruti'},
			   {img: '<img src="assets/img/smileys/boulet.gif" class="sm">', bbcode:" :boulet: ", title: 'Boulet'},
			   {img: '<img src="assets/img/smileys/clin.gif" class="sm">', bbcode:" :clin: ", title: 'Clin oeil'},
			   {img: '<img src="assets/img/smileys/lol.gif" class="sm">', bbcode:" lol ", title: 'lol'},
			   {img: '<img src="assets/img/smileys/modo10.gif" class="sm">', bbcode:" :modo10: ", title: 'Police'},
			   {img: '<img src="assets/img/smileys/ninja.gif" class="sm">', bbcode:" :ninja: ", title: 'Ninja'},
			   {img: '<img src="assets/img/smileys/simley.png" class="sm">', bbcode:" :smile1: ", title: 'Smile 1'},
			   {img: '<img src="assets/img/smileys/troll/1.png" class="sm">', bbcode:" :troll: ", title: 'Troll'},
			   {img: '<img src="assets/img/smileys/troll/troll.png" class="sm">', bbcode:" :troll1: ", title: 'Troll1'},
			   {img: '<img src="assets/img/smileys/informatique/infect10.gif" class="sm">', bbcode:" :infectionpc: ", title: 'Infection pc'},
			   {img: '<img src="assets/img/smileys/informatique/smiley10.gif" class="sm">', bbcode:" :matrix: ", title: 'Matrix'},
			   {img: '<img src="assets/img/smileys/informatique/mdr1.gif" class="sm">', bbcode:" :mdr1: ", title: 'MDR'},
	...
	$.wysibb.prototype = {
		...
		build: function() {
			...
			if (this.options.onlyBBmode===false) {
				...
				this.$body = $(this.strf('<div class="wysibb-text-editor" style="max-height:{maxheight}px;min-height:150px"></div>',{maxheight:mheight,height:height})).insertAfter(this.$txtArea);
